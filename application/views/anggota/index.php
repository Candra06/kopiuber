<head>
  ...
  <body>
      ...
      <?php
      include str_replace("system", "application/views/anggota/", BASEPATH)."/layout/sidebar.php"; 
      include str_replace("system", "application/views/anggota/", BASEPATH)."/layout/head.php";
     ...
     <div class="br-mainpanel">
      ...
      <?php
        include str_replace("system", "application/views/anggota/", BASEPATH)."/layout/content.php";
      ?>
